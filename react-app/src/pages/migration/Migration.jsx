      ...
      <main id="main-content" className="body-container-wrapper">
        <div className="body-container">
          <HeroV1
            ...
            paragraphs={['<strong>Stop migrating your technical debt.</strong> We engineer the automated transition from bloated legacy monoliths to modern, headless architectures with 100% data integrity and zero &ldquo;wait, where did that page go?&rdquo; moments.']}
            imagePosition="none"
            textAlign="left"
            ctas={[
