...
class AssetQuery extends baseQuery.BaseQuery {
  constructor(client) {
    super();
    this._client = client;
   ...
   */
  query() {
    return new query.Query(this._client, this._parameters, this._queryParams);
  }
}

exports.AssetQuery = AssetQuery;
//# sourceMappingURL=asset-query.cjs.map
