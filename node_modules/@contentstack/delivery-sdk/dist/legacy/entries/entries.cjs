...
var baseQuery = require('../query/base-query.cjs');
var query = require('../query/query.cjs');
...
class Entries extends baseQuery.BaseQuery {
  ...
  includeReference(...referenceFieldUid) {
    if (referenceFieldUid.length) {
      ...
      console.error(errorMessages.ErrorMessages.INVALID_ARGUMENT_STRING_OR_ARRAY);
    }
    return this;
  }
  /**
   ...
   */
  query(queryObj) {
    if (queryObj) return new query.Query(this._client, this._parameters, this._queryParams, this._variants, this._contentTypeUid, queryObj);
    return new query.Query(this._client, this._parameters, this._queryParams, this._variants, this._contentTypeUid);
  }
  /**
   * @method variants
   * @memberof Entries
  ...
  async find(encode = false) {
    ...
    if (Object.keys(this._parameters).length > 0) {
      ...
      if (encode) {
        queryParams = utils.encodeQueryParams(queryParams);
      }
