...
var asset = require('../assets/asset.cjs');
var contenttypeQuery = require('../query/contenttype-query.cjs');
var assetQuery = require('../query/asset-query.cjs');
var taxonomyQuery = require('../query/taxonomy-query.cjs');
var globalFieldQuery = require('../query/global-field-query.cjs');
var index = require('../content-type/index.cjs');
var synchronization = require('../sync/synchronization.cjs');
var index$1 = require('../global-field/index.cjs');
...
class Stack {
  ...
  asset(uid) {
    if (uid) return new asset.Asset(this._client, uid);
    return new assetQuery.AssetQuery(this._client);
  }
  contentType(uid) {
    if (uid) return new index.ContentType(this._client, uid);
    return new contenttypeQuery.ContentTypeQuery(this._client);
  }
  /**
     * @method Taxonomy
     * @memberof Stack
     ...
     */
  taxonomy() {
    return new taxonomyQuery.TaxonomyQuery(this._client);
  }
  globalField(uid) {
    if (uid) return new index$1.GlobalField(this._client, uid);
    return new globalFieldQuery.GlobalFieldQuery(this._client);
  }
  /**
   * @method setLocale
   * @memberof Stack
  ...
  async sync(params = {}, recursive = false) {
    return await synchronization.synchronization(this._client, params, recursive);
  }
  ...
  async getLastActivities() {
    try {
      const result = await core.getData(this._client, "/content_types", {
        params: {
